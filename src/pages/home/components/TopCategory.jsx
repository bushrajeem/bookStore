  ...
  return (
    <div className="px-[100px] py-[70px]"> 
      <div className="flex items-center justify-between mb-11">
        ...
        <button className="mt-7 flex p-6 items-center gap-5 h-[60px] border-[1px] border-gray-400 rounded-4xl text-gray-700 font-bold hover:bg-orange-400 hover:text-white hover:border-none">
          <NavLink to="/shop">Explore More</NavLink>
          <MoveRight />{" "}
        </button>
      </div>
      <div className="grid grid-cols-3 gap-5">
        {topbookinfo?.slice(0, 3).map((item, i) => (
          <div
            key={i}
